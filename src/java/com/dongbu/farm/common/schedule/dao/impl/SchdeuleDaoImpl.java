...
public class SchdeuleDaoImpl implements IScheduleDao{
	...
	public List<Schedule> getSchduleList(Map<String, String> searchMap)throws DataAccessException {
		return this.sqlSession.selectList(SCHDULE_STATEMENTNAME + "getSchduleList" , searchMap);
	}

	@Override
	public Schedule getSchedule(Map<String, String> searchMap) throws DataAccessException {
		return (Schedule) this.sqlSession.selectOne(SCHDULE_STATEMENTNAME + "getSchedule" , searchMap);
	}
	...
	public void writeSchedule(Schedule schedule) throws DataAccessException {
		...
		String seq = (String)this.sqlSession.selectOne(SCHDULE_STATEMENTNAME + "writeScheduleKey" , schedule.getStd_date());

		//증가된값을 셋팅
		schedule.setSch_seq(seq);
		
		this.sqlSession.insert(SCHDULE_STATEMENTNAME + "writeSchedule" , schedule);
	}

	@Override
	public void modifySchedule(Schedule schedule) throws DataAccessException {
		this.sqlSession.update(SCHDULE_STATEMENTNAME + "modifySchedule" , schedule);		
	}

	@Override
	public void deleteSchedule(Schedule schedule) throws DataAccessException {
		this.sqlSession.delete(SCHDULE_STATEMENTNAME + "deleteSchedule" , schedule);		
	}
